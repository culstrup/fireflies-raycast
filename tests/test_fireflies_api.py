...
class TestFirefliesAPI(unittest.TestCase):
    ...
    def test_execute_query_success(self, mock_session_class):
        ...
        mock_response.json.return_value = {"data": {"some_field": "test_value"}}
    ...
    def test_execute_query_graphql_error(self, mock_session_class):
        ...
        mock_response = MagicMock()
        mock_response.status_code = 200
        mock_response.json.return_value = {"errors": [{"message": "Field does not exist"}], "data": None}
        mock_session.post.return_value = mock_response
    ...
    def test_get_recent_transcripts(self, mock_execute_query):
        ...
        mock_execute_query.return_value = {
            "transcripts": [{"id": "123", "title": "Test Meeting", "dateString": "2023-01-01"}]
        }
    ...
    def test_get_transcript_by_id(self, mock_execute_query):
        ...
        # Mock response from execute_query
        mock_execute_query.return_value = {"transcript": {"id": "123", "title": "Test Meeting"}}
